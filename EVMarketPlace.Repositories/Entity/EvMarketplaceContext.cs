...
public partial class EvMarketplaceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuctionId).HasName("PK__Auctions__51004A4CACC52336");

            entity.HasIndex(e => e.PostId, "UQ__Auctions__AA126019634FB1E9").IsUnique();
        ...
        {
            entity.HasKey(e => e.BidId).HasName("PK__AuctionB__4A733D92872E7E3A");
        ...
        {
            entity.HasKey(e => e.BatteryId).HasName("PK__Batterie__5710805ECC1716C5");

            entity.HasIndex(e => e.PostId, "UQ__Batterie__AA1260197659B5E1").IsUnique();
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__BatteryB__DAD4F05E15FC5D8E");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B0A45F42A35");
        ...
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__Favorite__CE74FAD534B6F1FA");
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__Posts__AA1260187EA575C3");
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__PostImag__7516F70CF33F7E5E");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79CEED1409CC");
            ...
            entity.HasOne(d => d.Post).WithMany(p => p.Reviews)
                .HasForeignKey(d => d.PostId)
                .HasConstraintName("FK__Reviews__PostId__7A672E12");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Shopping__51BCD7B73965BFE7");

            entity.HasIndex(e => e.UserId, "UQ__Shopping__1788CC4D65B5B829").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A6BD377EC43");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C40EC4DA9");

            entity.HasIndex(e => e.Phone, "UQ__Users__5C7E359E8F331841").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534E98C46E9").IsUnique();
        ...
        {
            entity.HasKey(e => e.VehicleId).HasName("PK__Vehicles__476B549259C37EF3");

            entity.HasIndex(e => e.PostId, "UQ__Vehicles__AA1260199A530BA3").IsUnique();
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__VehicleB__DAD4F05EA064DDF3");
        ...
        {
            entity.HasKey(e => e.WalletId).HasName("PK__Wallets__84D4F90EDEF0D52C");

            entity.HasIndex(e => e.UserId, "UQ__Wallets__1788CC4D27E978A6").IsUnique();
